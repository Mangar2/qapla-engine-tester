...
tests=(
  ...
  "--logpath=log --enginelog --concurrency=20 --epd file=wmtest.epd maxtime=20 mintime=1 seenplies=3 minsuccess=80 --engine conf=Qapla 0.3.2 --enginesfile=./linux-engines.ini:13"
  "--logpath=log --concurrency=20 --tc=10+0.02 --sprt elolower=0 eloupper=10 alpha=0.05 beta=0.05 maxgames=300 --engine conf=Qapla 0.3.1 --engine conf=Qapla 0.3.2 --openings file=book8ply.raw format=raw --enginesfile=./linux-engines.ini:16"
