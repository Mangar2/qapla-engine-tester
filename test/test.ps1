$tests = @(
    ...
    ,@{ args = "--sprt elolower=50 eloupper=60 alpha=0.05 beta=0.05 maxgames=3000 --logpath=log --concurrency=10 --each tc=10+0.02 --pgnoutput file=log/debug.pgn append=false --enginelog --engine conf=""Qapla 0.3.2"" ponder --engine conf=""Qapla 0.3.2"" --openings file=book8ply.raw format=raw --enginesfile=engines.ini"; expectedCode = 11 }
