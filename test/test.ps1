$tests = @(
    ...
    #--tournament type=gauntlet resultfile=log/tournamet.txt games=12 repeat=2 rounds=10 --interactive --engine conf="Qapla 0.3.2" gauntlet --engine conf="Qapla 0.3.2" trace=all --engine conf="Qapla 0.3.1" --enginesfile=C:\Development\qapla-engine-tester\test\engines.ini --logpath=log --enginelog --pgnoutput file=log/test.pgn --each tc=10+0.02 --openings order=random file=test/book8ply.raw format=raw
    ...
    #--sprt elolower=0 eloupper=10 alpha=0.05 beta=0.05 maxgames=300 --logpath=log --concurrency=1 --each tc=10+0.02 --engine conf="Qapla 0.3.1" --engine conf="Qapla 0.3.2" --openings file=test\book8ply.raw format=raw --enginesfile=C:\Development\qapla-engine-tester\test\engines.ini 
