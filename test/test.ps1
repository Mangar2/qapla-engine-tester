$tests = @(
    ...
    ,@{ args = "--test numgames=20 nostop --engine conf=""Qapla 0.3.2"" --enginesfile=""C:\Development\qapla-engine-tester\test\engines.ini"" --logpath=log --enginelog "; expectedCode = 0 }
    ...
    ,@{ args = "--logpath=log --concurrency=10 --each tc=10+0.02 --pgnoutput file=log/debug.pgn append=false --enginelog --sprt elolower=50 eloupper=60 alpha=0.05 beta=0.05 maxgames=3000 --engine conf=""Qapla 0.3.2"" ponder --engine conf=""Qapla 0.3.2"" --openings file=book8ply.raw format=raw --enginesfile=engines.ini"; expectedCode = 10 }
